#ifndef INSPECTION_SIM_DWA_CONTROLLER__DWA_CONTROLLER_HPP_
#define INSPECTION_SIM_DWA_CONTROLLER__DWA_CONTROLLER_HPP_
...
namespace inspection_sim_dwa_controller
{
...
private:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("inspection_sim_dwa_controller")};
